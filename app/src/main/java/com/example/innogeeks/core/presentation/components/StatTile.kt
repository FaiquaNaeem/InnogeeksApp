...
private fun StatTileRowPreview() {
    InnogeeksTheme {
        ...
        Row(
            ...
            StatTile(value = 42, caption = "Members", hazeState = hazeState, modifier = Modifier.weight(1f))
            StatTile(value = 12, caption = "Projects", hazeState = hazeState, modifier = Modifier.weight(1f))
            StatTile(value = 95, caption = "Placement", suffix = "%", hazeState = hazeState, modifier = Modifier.weight(1f))
        }
    }
}
